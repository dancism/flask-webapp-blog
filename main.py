...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite://///Users/danielnyakas/programming/100daysofpython/day_69/day-69-starting-files-blog-with-users/instance/posts.db'
db = SQLAlchemy()
db.init_app(app)
